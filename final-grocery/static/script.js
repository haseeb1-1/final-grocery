...
body {
    ...
    /* Background image */
    background: url('/static/images/hover-cart.jpg') no-repeat center center fixed;
    background-size: cover;
}
...
body {
    ...
    /* Background image */
    background: url('/static/images/admin-dashboard.jpg') no-repeat center center fixed;
    background-size: cover;
}
